...
let defaultMDCDialogTransitionController = MDCDialogTransitionController()
...
extension UIViewController {
    func showFilterDialog(viewControllerToRefresh: ImagesViewController) {
        ...
        presentBottomSheet(content: filterChoiceContent, transitionController: defaultMDCDialogTransitionController) { [weak viewControllerToRefresh] (selectedIndex) in
